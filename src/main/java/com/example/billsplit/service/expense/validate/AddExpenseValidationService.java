...
public class AddExpenseValidationService {
    ...
    public void validateExpense(AddExpenseInput addExpenseInput) {
        ...
        throw new RuntimeException("User doesn't exist in group");
    }
}
